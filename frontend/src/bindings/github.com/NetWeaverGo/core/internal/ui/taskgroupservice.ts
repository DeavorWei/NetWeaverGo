 ...
 */
export function CreateTaskGroup(group: config$0.TaskGroup): $CancellablePromise<config$0.TaskGroup | null> {
 ...
 */
export function DeleteTaskGroup(id: string): $CancellablePromise<void> {
 ...
 */
export function GetTaskGroup(id: string): $CancellablePromise<config$0.TaskGroup | null> {
 ...
 */
export function StartTaskGroup(id: string): $CancellablePromise<void> {
 ...
 */
export function UpdateTaskGroup(id: string, group: config$0.TaskGroup): $CancellablePromise<config$0.TaskGroup | null> {
