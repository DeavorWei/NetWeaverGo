...
type TaskRun struct {
    ...
    RunKind          string         `json:"runKind"` // normal / topology / backup / ceas / inspection
...
type TaskRunStage struct {
    ...
    StageKind      string     `json:"stageKind"` // device_command / device_collect / parse / topology_build / backup_collect / ceas_collect / inspection_check
