...
- [NetWeaverGo 项目架构说明书](#netweavergo-项目架构说明书)
  - [目录](#目录)
  - [1. 项目概览](#1-项目概览)
    - [核心能力矩阵](#核心能力矩阵)
  - [2. 技术栈](#2-技术栈)
  ...
  - [4. 后端架构（Go）](#4-后端架构go)
    ...
    - [4.12 拓扑构建 internal/taskexec/topology\_builder.go](#412-拓扑构建-internaltaskexectopology_buildergo)
    ...
    - [4.20 SNMP 功能模块 internal/snmp/](#420-snmp-功能模块-internalsnmp)
      - [4.20.1 架构分层](#4201-架构分层)
      - [4.20.2 MIB 管理模块](#4202-mib-管理模块)
      - [4.20.3 轮询模块](#4203-轮询模块)
      - [4.20.4 Trap 监听模块](#4204-trap-监听模块)
      - [4.20.5 事件通知模块](#4205-事件通知模块)
      - [4.20.6 数据模型关系](#4206-数据模型关系)
      - [4.20.7 文件索引](#4207-文件索引)
  - [5. 前端架构（Vue 3 + TypeScript）](#5-前端架构vue-3--typescript)
    ...
    - [5.6 SNMP 前端 Composables 层](#56-snmp-前端-composables-层)
    - [5.7 SNMP 视图层](#57-snmp-视图层)
    - [5.6 组件体系](#56-组件体系)
    - [5.8 样式架构](#58-样式架构)
  - [6. 数据库设计](#6-数据库设计)
    - [6.1 数据库选型](#61-数据库选型)
    - [6.2 核心表结构](#62-核心表结构)
    - [6.3 SNMP 数据模型关系](#63-snmp-数据模型关系)
  - [7. 构建与部署](#7-构建与部署)
    - [7.1 构建流程](#71-构建流程)
  ...
  - [9. 数据流全景图](#9-数据流全景图)
    - [普通任务执行流](#普通任务执行流)
    - [拓扑任务执行流](#拓扑任务执行流)
    - [SNMP MIB 导入数据流](#snmp-mib-导入数据流)
    - [SNMP 轮询数据流](#snmp-轮询数据流)
    - [SNMP Trap 接收数据流](#snmp-trap-接收数据流)
    - [SNMP 实时通信机制](#snmp-实时通信机制)
  - [10. 模块依赖关系](#10-模块依赖关系)
    - [10.1 SNMP 模块依赖关系](#101-snmp-模块依赖关系)
    - [10.2 SNMP 前端依赖关系](#102-snmp-前端依赖关系)
